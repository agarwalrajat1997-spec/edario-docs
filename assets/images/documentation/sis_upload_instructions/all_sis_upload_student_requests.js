...
export default function AllSisUploadStudentRequestsDocs({ sisList, sis, currentStep, handleGoToNextPage, handleGoToPreviousPage }) {
		...
		<div className="documentation-page" data-page='courses'>
			<div className="documentation-step-page">
				...
				{currentStep === 1 &&
					...
					<p>Contact your rep at {sis_name} and tell them you need an Excel file with your student requests for this year.</p> 

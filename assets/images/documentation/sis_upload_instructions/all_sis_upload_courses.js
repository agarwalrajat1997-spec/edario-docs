...
export default function AllSisUploadCoursesDocs({ sisList, sis, currentStep, handleGoToNextPage, handleGoToPreviousPage }) {
	...
	return (
		<div className="documentation-page" data-page='courses'>
			<div className="documentation-step-page">
				<h2>Upload Courses from {sis_name}</h2>
				{currentStep === 1 &&
					<>
					...
					<p>Contact your rep at {sis_name} and tell them you need an Excel file with all your course data.</p> 
